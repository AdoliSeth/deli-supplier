...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO liquorstores(shop_name, image, location, description) VALUES('$shop_name', '$image', '$location', '$description')";

    if (mysqli_query($conn, $query)){
        header('Location: '.ROOT_URL.'liquorstores.php');
    }else{
