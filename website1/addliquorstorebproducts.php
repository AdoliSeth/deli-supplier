...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO liquorstoreproductsb(title, image, description, price) VALUES('$title', '$image', '$description', '$price')";

    if (mysqli_query($conn, $query)){
        header('Location: '.ROOT_URL.'liquorstorebproducts.php');
    }else{
