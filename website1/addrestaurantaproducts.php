...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO restaurantproductsa(title, image, description, price) VALUES('$title', '$image', '$description', '$price')";

    if (mysqli_query($conn, $query)){
        header('Location: '.ROOT_URL.'restaurantaproducts.php');
    }else{
