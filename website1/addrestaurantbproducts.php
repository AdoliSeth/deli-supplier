...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO restaurantproductsb(title, image, description, price) VALUES('$title', '$image', '$description', '$price')";

    if (mysqli_query($conn, $query)){
        header('Location: '.ROOT_URL.'restaurantbproducts.php');
    }else{
