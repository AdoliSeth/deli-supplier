...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO shops(shop_name, image, location, description) VALUES('$shop_name', '$image', '$location', '$description')";

    if (mysqli_query($conn, $query)){
        header('Location: '.ROOT_URL.'shops.php');
    }else{
...
<div class="container">
    ...
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" style="font-weight: bold; color: orange">
        <fieldset>
            ...
            <button class="btn btn-warning btn-block" name="submit" value="Submit" type="submit">Add Shop</button>
        </fieldset>
    </form>
</div>
<!-- Optional JavaScript -->
