...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO supermarkets(shop_name, image, location, description) VALUES('$shop_name', '$image', '$location', '$description')";
...
<div class="container">
    ...
    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" style="font-weight: bold; color: orange">
        <fieldset>
            ...
            <button class="btn btn-warning btn-block" name="submit" value="Submit" type="submit">Add Supermarket</button>
        </fieldset>
    </form>
</div>
<!-- Optional JavaScript -->
