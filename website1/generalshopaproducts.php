...
//  create query
$query = 'SELECT * FROM generalshopproductsa ORDER BY created_at DESC';
...
//fetch data
if (!empty($result)) {
    $generalshopproductsa = mysqli_fetch_all($result, MYSQLI_ASSOC);
}
...
<section>
    <div class="container">
        <h1>General shop A Products</h1>
        <div class="row">
            <?php foreach($generalshopproductsa as $post):  ?>
