...
<div class="container">
    <h1>Groceries</h1>
    <div class="row">
        <?php foreach($groceries as $grocerie):  ?>
            <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
                    <div class="card-header"><?php echo $grocerie['shop_name'] ?></div>
                    <div class="card-body">
                        <img style="width: 100%; height: 30vh" src="<?php echo $grocerie['image'] ?>" class="img-responsive" > <br>
                        <p class="card-title"><?php echo $grocerie['location'];?></p>
                        <p class="card-text"><?php echo $grocerie['description']?></p>
