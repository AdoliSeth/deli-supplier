...
//  create query
$query = 'SELECT * FROM groproductsa ORDER BY created_at DESC';
...
//fetch data
if (!empty($result)) {
    $groproductsa = mysqli_fetch_all($result, MYSQLI_ASSOC);
}
...
<section>
    <div class="container">
        <h1>Grocery A Products</h1>
        <div class="row">
            <?php foreach($groproductsa as $post):  ?>
                <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-default" style="background-color: darkorange" href="<?php echo ROOT_URL;?>groacartthree.php?id=<?php echo $post['id'];?>">Add to Cart</a>
                        </div>
                    </div>
