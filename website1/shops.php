            ...
            <?php foreach($shops as $shop):  ?>
                <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
                        <div class="card-header"><?php echo $shop['shop_name'] ?></div>
                        <div class="card-body">
                            <img style="width: 100%; height: 30vh" src="<?php echo $shop['image'] ?>" class="img-responsive" > <br>
                            <small class="card-title"> Ksh <?php echo $shop['location'];?></small>
...
<!--                            <small>Posted on --><?php //echo $post['created_at'] ?><!-- by </small>-->
                            <hr>
                            <a class="btn btn-default" style="background-color: darkorange" href="<?php echo ROOT_URL;?>index.php?id=<?php echo $shop['id'];?>">View products</a>
                        </div>
                    </div>
