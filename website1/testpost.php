...
<div class="container">
    ...
    <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
        ...
        <div class="card-body">
            ...
            <hr>
            <a name="submit" value="Submit" type="submit" class="btn btn-default" style="background-color: darkorange" href="<?php echo ROOT_URL;?>post.php?id=<?php echo $posts['id'];?>">Buy Now</a>
